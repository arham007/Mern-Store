...
<div style={{ backgroundColor: "#FAFAFA", width: "350px", height: "500px", display: "flex", flexDirection: "column",marginTop:"50px" }}>
    ...
    <div >
...

        {
                    ...
                    <Snackbar style={{marginTop:"30px"}} open={err} autoHideDuration={6000} onClose={()=>{setErr(false)}} >
                    <Alert severity="error" style={{fontSize:"16px"}} >{error}</Alert>   
                    </Snackbar>
    </div>
